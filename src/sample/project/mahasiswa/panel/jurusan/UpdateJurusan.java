...
public class UpdateJurusan extends javax.swing.JPanel {
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        int index = jTable1.getSelectedRow();
        if (index == -1) {
            JOptionPane.showMessageDialog(jButtonClear, "Silahkan seleksi baris yang akan diUpdate");
        } else {
